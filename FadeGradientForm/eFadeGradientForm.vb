...
#Region " FadeGradientForm "
    ...
    Public Class eFadeGradientForm
        Inherits System.Windows.Forms.Form

#Region " Variables "

        Private m_GradientBegin, m_GradientMiddle, m_GradientEnd As Color
        ...
        Public Property GradientBegin() As Color
            ...
            Set(ByVal value As Color)
                If m_GradientBegin <> value Then
                    ...
                    m_GradientPreset = eForms.GradientPresets.Custom
                    Me.Refresh()
                End If
            End Set
        End Property
            ...
            Set(ByVal value As GradientPresets)
                If m_GradientPreset <> value Then
                    ...
                    Select Case value
                        ...
                        Case GradientPresets.RoyalLight
                            m_GradientBegin = Color.LightCyan
                            m_GradientMiddle = Color.LightBlue
                            m_GradientEnd = Color.RoyalBlue
