...
Namespace UIControls.DataGridView
    ...
    ''' shown. 
    ''' </summary>
    Class eDataGridViewColumnSelector
        ' the DataGridView to which the DataGridViewColumnSelector is attached
        Private mDataGridView As Windows.Forms.DataGridView = Nothing
        ...
        ''' </summary>
        Public Property DataGridView() As Windows.Forms.DataGridView
            Get
        ...
        Public Sub New(ByVal dgv As Windows.Forms.DataGridView)
            Me.New()
            Me.DataGridView = dgv
        End Sub
