...
Namespace UIControls.ProgressBar
    ...
    <ToolboxBitmap(GetType(eVistaProgressBar), "Resources.vista_progress_bar.bmp")> _
    Public Class eVistaProgressBar
...
#Region "- Properties -"
        ...
        Private PTextLabel As New Windows.Forms.Label
...
#End Region
        ...
        Private Sub VistaProgressBar_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
