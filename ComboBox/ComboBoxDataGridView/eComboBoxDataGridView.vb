...
Namespace UIControls.ComboBox
    <ToolboxItem(True)> _
<ToolboxBitmap(GetType(Windows.Forms.ComboBox))> _
...
Partial Public Class eComboBoxDataGridView
...
#End Region
        ...
        Public ReadOnly Property AttachedGrid() As System.Windows.Forms.DataGridView
            Get
        ...
        Public Sub AddDataGridView(ByVal nDataGridView As Windows.Forms.DataGridView, ByVal nCloseOnSingleClick As Boolean)
            If Not myDataGridView Is Nothing Then Throw New Exception( _
                "Error. DataGridView is already assigned to the ComboBox.")
        ...
        Private Function CalculatePoz() As Drawing.Point

            Dim point As New Drawing.Point(0, Me.Height)

            If (Me.PointToScreen(New Drawing.Point(0, 0)).Y + Me.Height + Me.myDataGridView.Height) _
