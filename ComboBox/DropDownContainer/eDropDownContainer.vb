...
Namespace UIControls.DropDownContainer
    <ToolboxItem(True), ToolboxBitmap(GetType(eDropDownContainer), "eDropDownContainer.eDropDownContainer.bmp")> _
    <Designer(GetType(eDropDownContainerDesigner))> _
    <DefaultEvent("DropDown")> _
            Public Class eDropDownContainer
...
#Region "Initialize"
        ...
        Private Sub eDropDownContainer_HandleCreated(ByVal sender As Object, _
...
#Region "Mouse Events"
        ...
        Private Sub eDropDownContainer_MouseDown(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles Me.MouseDown
        ...
        Private Sub eDropDownContainer_MouseUp(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles Me.MouseUp
...
#Region "Control Events"
        ...
        Private Sub eDropDownContainer_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize
        ...
        Private Sub eDropDownContainer_MouseDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles Me.MouseDoubleClick
            If Not _IsOpen AndAlso Me.rectTextBox.Contains(e.Location) Then OpenDropDown()
        End Sub

        Private Sub eDropDownContainer_ControlRemoved(ByVal sender As Object, ByVal e As System.Windows.Forms.ControlEventArgs) Handles Me.ControlRemoved
...
#Region "eDropDownContainer SmartTag"

#Region "eDropDownContainerDesigner"

    Public Class eDropDownContainerDesigner

        Inherits ScrollableControlDesigner

        Protected Overrides Function GetHitTest(ByVal point As System.Drawing.Point) As Boolean
            Dim DDC As eDropDownContainer = CType(Component, eDropDownContainer)
...
#End Region 'eDropDownContainerDesigner
...
#Region "DDPActionList"
    ...
    Public Class DDPActionList
        ...
        Private _DDCSelector As eDropDownContainer
        ...
        Public Sub New(ByVal component As IComponent)
            ...
            _DDCSelector = DirectCast(component, eDropDownContainer)
...
#Region "TextBox"
        ...
        Public Property TextBoxGradientType() As eDropDownContainer.eGradientType
            Get
                Return _DDCSelector.TextBoxGradientType
            End Get
            Set(ByVal value As eDropDownContainer.eGradientType)
...
#Region "Drop Down Button"
        ...
        Public Property ButtonShape() As eDropDownContainer.eButtonShape
            Get
                Return _DDCSelector.ButtonShape
            End Get
            Set(ByVal value As eDropDownContainer.eButtonShape)
...
#End Region 'DropDown
        ...
        'For SmartTag
        Public ReadOnly Property CurrDDC() As eDropDownContainer
            Get
                Return _DDCSelector
            End Get
        End Property
...
#Region "Action Items"
        ...
        Public Overrides Function GetSortedActionItems() As System.ComponentModel.Design.DesignerActionItemCollection
            ...
            If _DDCSelector.TextBoxGradientType <> eDropDownContainer.eGradientType.Solid Then
                items.Add( _
                    New DesignerActionPropertyItem( _
                        "TextBoxBackColorB", _
                        "Fill Color B", _
...
#End Region 'eDropDownContainer SmartTag
...
#Region "DropControlsEditor"
    ...
    Public Class DropControlsEditor
        ...
        Public Overrides Function EditValue(ByVal context As System.ComponentModel.ITypeDescriptorContext, ByVal provider As System.IServiceProvider, ByVal value As Object) As Object
            ...
            End If
            Dim Instance As eDropDownContainer
            If context.Instance.GetType Is GetType(eDropDownContainer) Then
                Instance = CType(context.Instance, eDropDownContainer)
            Else
