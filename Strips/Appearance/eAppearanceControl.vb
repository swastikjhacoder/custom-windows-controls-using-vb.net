...
Namespace Appearance
    Public Class eAppearanceControl
        Inherits Component
        ...
        Public Class AppearanceProperties
            ...
            Public Sub SetAppearanceControl(ByVal ap As eAppearanceControl)
            ...
            Public Sub New(ByVal appearanceControl As eAppearanceControl)
...
#Region " Property Group Classes "
            ...
            Public Class SelectedButtonAppearanceProperties
                ...
                Private ap As eAppearanceControl
                Public Sub New(ByVal appearanceControl As eAppearanceControl)
                    ap = appearanceControl
                End Sub

                Public Sub SetAppearanceControl(ByVal appearanceControl As eAppearanceControl)
                    ap = appearanceControl
                End Sub
...
#Region " Color Tables "
        ...
        Public Class CustomColorTable
            ...
            Private ac As eAppearanceControl = Nothing
