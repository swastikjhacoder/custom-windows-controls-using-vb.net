...
Namespace Appearance
    Public Class frmAppearanceEditor
        ...
        Private _ap As eAppearanceControl.AppearanceProperties = Nothing

        Public Sub New(ByVal ap As eAppearanceControl.AppearanceProperties)
            InitializeComponent()
            _ap = ap
        ...
        Public ReadOnly Property CustomAppearance() As eAppearanceControl.AppearanceProperties
            Get
                Return _ap
            End Get
        End Property
        ...
        Public Sub LoadAppearance(ByVal xmlFile As String)
            Try
                Using fs As New FileStream(xmlFile, FileMode.Open, FileAccess.Read, FileShare.None)
                    Dim ser As New XmlSerializer(GetType(eAppearanceControl.AppearanceProperties))

                    Dim ap As eAppearanceControl.AppearanceProperties
                    ap = DirectCast(ser.Deserialize(fs), eAppearanceControl.AppearanceProperties)
                    _ap = ap
                    Me.CustomizableMenuStrip1.Appearance.CustomAppearance = ap
                    Me.CustomizableStatusStrip1.Appearance.CustomAppearance = ap
                    Me.CustomizableToolStrip1.Appearance.CustomAppearance = ap
        ...
        Public Sub LoadFromStream(ByVal stream As Stream)
            Try
                ...
                Dim ap As eAppearanceControl.AppearanceProperties
                ap = DirectCast(ser.Deserialize(stream), eAppearanceControl.AppearanceProperties)
        ...
        Public Sub SaveAppearance(ByVal xmlFile As String, ByVal ac As eAppearanceControl)
            Try
